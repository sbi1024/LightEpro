...
public class SchAuthorityHelper {
    ...
    public boolean calendarBranchProcessing(SchRqDto999 schRqDto999) throws Exception {
        ...
        /** 조회인 경우 */
            ...
            if (getCalAuthority.equalsIgnoreCase(SchConstValue.MASTER_AUTHORITY) || getCalAuthority.equalsIgnoreCase(SchConstValue.WRITE_AUTHORITY)) {
                return true;
            } else {
                ...
                // 현재 조회하고자 하는 캘린더에 포함된 일정 구성원 중, 마스터/쓰기/읽기 권한을 가진 구성원인 경우
                if (getSchAuthorityByCal.equalsIgnoreCase(SchConstValue.MASTER_AUTHORITY) ||
    ...
    public boolean scheduleBranchProcessing(SchRqDto999 schRqDto999) throws Exception {
        ...
        /** 조회인 경우 */
            ...
            if (getCalAuthority.equalsIgnoreCase(SchConstValue.MASTER_AUTHORITY) ||
                    getCalAuthority.equalsIgnoreCase(SchConstValue.WRITE_AUTHORITY) ||
                    getCalAuthority.equalsIgnoreCase(SchConstValue.READ_AUTHORITY) ||
