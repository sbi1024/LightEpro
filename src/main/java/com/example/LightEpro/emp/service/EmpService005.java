...
public interface EmpService005 {
    EmpRsDto005 createCompanyInfo(EmpRqDto005 empRqDto005) throws Exception;

    void assignObject(EmpRqDto005 empRqDto005) throws Exception;
    void confirmCompanySequence(EmpRqDto005 empRqDto005) throws Exception;

    int findCompanySequence() throws Exception;
