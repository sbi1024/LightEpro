...
public interface EmpService000 {
    EmpRsDto000 createDepartmentInfo(EmpRqDto000 empRqDto000) throws Exception;

    void assignObject(EmpRqDto000 empRqDto000) throws Exception;

    void confirmDepartmentSequence(EmpRqDto000 empRqDto000) throws Exception;

    int findDepartmentSequence() throws Exception;
